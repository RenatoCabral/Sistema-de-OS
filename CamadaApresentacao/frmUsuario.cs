...
namespace CamadaApresentacao
{
    public partial class frmUsuario : Form
    {
        ...
        {
            InitializeComponent();
            this.ttMensagem.SetToolTip(this.txtNome, "Informe o nome do usuário.");
            this.ttMensagem.SetToolTip(this.txtSenha, "Informe a senha do usuário.");
            this.ttMensagem.SetToolTip(this.cbbAcesso, "Informe o nível de acesso do usuário.");
        ...
        {
            this.dataLista.DataSource = NUsuario.Mostrar();
            this.OcultarColunas();
        ...
        {
            this.txtCodigo.Text = Convert.ToString(this.dataLista.CurrentRow.Cells["idusuario"].Value);
                ...
                if (Opcao == DialogResult.OK)
                {
                    ...
                    foreach (DataGridViewRow row in dataLista.Rows)
                    {
                        if (Convert.ToBoolean(row.Cells[0].Value))
                        {
                            ...
                            Resp = NUsuario.Excluir(Convert.ToInt32(Codigo));
